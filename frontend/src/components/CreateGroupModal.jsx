...
const CreateGroupModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" role="dialog" aria-modal="true">
      <div className="w-full max-w-md rounded-2xl bg-white dark:bg-base-100 shadow-xl border border-gray-200 dark:border-base-300 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-base-300 bg-white dark:bg-base-100 text-gray-900 dark:text-base-content placeholder:text-gray-500 focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20"
              required
            />
          </div>
          ...
          <div>
            ...
            <div className="max-h-48 overflow-y-auto space-y-2 rounded-xl border-2 border-gray-200 dark:border-base-300 p-2">
              {friends.length === 0 ? (
